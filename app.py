...
def upload():
    ...
    train_categories = ['Apple', 'Banana', 'Beetroot', 'Cauliflower', 'Coconut', 'Corn', 'Eggplant', 'Guava', 'Kiwi', 'Lemon', 'Litchi', 'Onion', 'Orange', 'Pineapple', 'Pomegranate', 'Potato', 'Starfruit', 'Strawberry', 'Tomato', 'Watermelon']
